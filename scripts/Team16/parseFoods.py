...
def parseFoods():
    foodFile = open("scripts/KnowledgeBase/FOOD_DES.txt","r")
    foods = {}
...
def parseFoodGroups():
    foodGroupFile = open("scripts/KnowledgeBase/FD_GROUP.txt","r")
    foodGroups = {}
...
def parseWeights():
    weightFile = open("scripts/KnowledgeBase/WEIGHT.txt", "r")
    weights = {}
...
def createStopList():
    stoplistFile = open("scripts/Team16/stoplist.txt", "r")
    stoplist = []
